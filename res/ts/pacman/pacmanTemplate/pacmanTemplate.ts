...
export abstract class PacmanTemplate {
    ...
    abstract getBottomLeftPoint(): {readonly posX: number; readonly posY: number};
    abstract getBottomRightPoint(): {readonly posX: number; readonly posY: number};

    protected abstract eatRightDirection(): {readonly posX: number; readonly posY: number};
    protected abstract eatLeftDirection(): {readonly posX: number; readonly posY: number};
    protected abstract eatTopDirection(): {readonly posX: number; readonly posY: number};
    protected abstract eatBottomDirection(): {readonly posX: number; readonly posY: number};
}